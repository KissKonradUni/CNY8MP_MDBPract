...
public class VendeglatasJSON {
    public static void main(String[] args) throws IOException {
        ObjectMapper m = new ObjectMapper();

        JsonNode root = m.readTree(new File("../vendeglatas.json"));
        ...
        JsonNode schemaNode = m.readTree(new File("../vendeglatas_schema.json"));
        ...
        if (foszakacsok != null && foszakacsok.isArray()) {
            for (JsonNode szakacs : foszakacsok) {
                ...
                System.out.println(" Név: " + nev + " | Kor : " + kor + " | Végzettség : "
                        + iskola);
            }
        }

        System.out.println("\n === Éttermek és szakácsaik === ");
        ...
        System.out.println(" \n === 2. Feladat : 5 csillagos éttermek === ");
        ...
        System.out.println("\n === 5. Feladat : JSON adatok manipulációja === ");
        for (JsonNode e : ettermek) {
        ...
        System.out.println(" \n === 6. Feladat : VIP Vendég ( Legtöbbet költő ) === ");
